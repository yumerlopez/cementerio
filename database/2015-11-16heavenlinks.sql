...
INSERT INTO `events` VALUES (1,1,'Evento Ejemplo 1','Evento Ejemplo 1','2015-11-16 19:06:00','2015-11-17 19:06:00'),(2,2,'Evento Ejemplo 2','Evento Ejemplo 2','2015-11-16 19:09:00','2015-11-20 19:09:00');
...
CREATE TABLE `multimedia` (
  ...
  PRIMARY KEY (`id`),
  KEY `multimedia_type_id_id_fkey` (`multimedia_type_id`),
  CONSTRAINT `multimedia_type_id_id_fkey` FOREIGN KEY (`multimedia_type_id`) REFERENCES `multimedia_types` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `user_beloved_ones` VALUES (1,1,'Daniel','López','1930-11-14','2015-11-14',1),(2,1,'Jose','Lopez','2015-11-14','2015-11-14',1);
...
-- Dump completed on 2015-11-16 16:02:08
