...
INSERT INTO `events` VALUES (1,1,'Evento Ejemplo 1','Evento Ejemplo 1','2015-11-16 19:06:00','2015-11-17 19:06:00'),(2,2,'Evento Ejemplo 2','Evento Ejemplo 2','2015-11-16 19:09:00','2015-11-20 19:09:00'),(3,11,'Prueba','Prueba','2015-11-17 20:20:00','2015-11-18 20:20:00');
...
CREATE TABLE `multimedia_collections` (
  ...
  CONSTRAINT `multimedia_collection_type_id_fkey` FOREIGN KEY (`multimedia_collection_type_id`) REFERENCES `multimedia_collection_types` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
INSERT INTO `multimedia_collections` VALUES (5,'General Photo Album','General Photo Album',1,11),(6,'General Video Collection','General Video Collection',2,11);
...
INSERT INTO `user_beloved_ones` VALUES (1,1,'Daniel','López','1930-11-14','2015-11-14',1),(2,1,'Jose','Lopez','2015-11-14','2015-11-14',1),(11,1,'Mario','López','2015-11-17','2015-11-18',1);
...
-- Dump completed on 2015-11-17 17:00:54
