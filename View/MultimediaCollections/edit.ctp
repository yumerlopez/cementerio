...
<?php echo $this->Form->create('MultimediaCollection'); ?>
	<fieldset>
		<legend><?php echo __('Edit Multimedia Collection'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MultimediaCollection.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('MultimediaCollection.id')))); ?></li>
