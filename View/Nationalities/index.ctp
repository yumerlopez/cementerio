<div class="nationalities index">
	...
	<tr>
		...
		<td><?php echo h($nationality['Nationality']['description']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $nationality['Nationality']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $nationality['Nationality']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
