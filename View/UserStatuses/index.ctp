<div class="userStatuses index">
	...
	<tr>
		...
		<td><?php echo h($userStatus['UserStatus']['description']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userStatus['UserStatus']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $userStatus['UserStatus']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
