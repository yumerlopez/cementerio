...
<?php echo $this->Form->create('UsersUsersStatus'); ?>
	<fieldset>
		<legend><?php echo __('Edit Users Users Status'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UsersUsersStatus.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('UsersUsersStatus.id')))); ?></li>
